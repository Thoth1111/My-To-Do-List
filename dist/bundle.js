...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _images_refresh_cw_svg__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./images/refresh-cw.svg */ \"./src/images/refresh-cw.svg\");\n/* harmony import */ var _images_corner_down_left_svg__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./images/corner-down-left.svg */ \"./src/images/corner-down-left.svg\");\n/* harmony import */ var _images_more_vertical_svg__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./images/more-vertical.svg */ \"./src/images/more-vertical.svg\");\n/* harmony import */ var _images_trash_2_svg__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./images/trash-2.svg */ \"./src/images/trash-2.svg\");\n/* harmony import */ var _modules_variables__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/variables */ \"./src/modules/variables.js\");\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n_modules_variables__WEBPACK_IMPORTED_MODULE_5__.refreshImg.src = _images_refresh_cw_svg__WEBPACK_IMPORTED_MODULE_1__;\r\n_modules_variables__WEBPACK_IMPORTED_MODULE_5__.enterImg.src = _images_corner_down_left_svg__WEBPACK_IMPORTED_MODULE_2__;\r\n_modules_variables__WEBPACK_IMPORTED_MODULE_5__.refreshDiv.appendChild(_modules_variables__WEBPACK_IMPORTED_MODULE_5__.refreshImg);\r\n_modules_variables__WEBPACK_IMPORTED_MODULE_5__.enterDiv.appendChild(_modules_variables__WEBPACK_IMPORTED_MODULE_5__.enterImg);\r\n\r\nclass Manager {\r\n  constructor (toDoList) {\r\n    this.toDoList = toDoList;\r\n  }\r\n\r\n  listAddition(description) {    \r\n    if (!this.toDoList) {\r\n      this.toDoList = [];\r\n    }\r\n    let entry = {\r\n      description,\r\n      index: _modules_variables__WEBPACK_IMPORTED_MODULE_5__.toDoList.length,\r\n      complete,\r\n    }    \r\n    this.toDoList.push(entry);\r\n    localStorage.setItem('compiled', JSON.stringify(this.toDoList));\r\n    this.listRender();\r\n  }\r\n\r\n  listRender() {\r\n    const listWindow = document.querySelector('.list-window');\r\n    let lists = '';\r\n    const sortedList = (0,_modules_variables__WEBPACK_IMPORTED_MODULE_5__.listSort)(_modules_variables__WEBPACK_IMPORTED_MODULE_5__.toDoList);\r\n    sortedList.forEach((entry) => {\r\n      lists += \r\n      `<div class=\"entry\">\r\n        <div>\r\n        <input type=\"checkbox\" class=\"boxes\" name=\"status\" id=\"status\">\r\n        <input type=\"text\" size=\"125\" class=\"detail\" value=\"${entry.description}\"></input>\r\n        </div>\r\n        <img src='${_images_more_vertical_svg__WEBPACK_IMPORTED_MODULE_3__}' id='more-icon' alt='more-icon'>\r\n        <img src='${_images_trash_2_svg__WEBPACK_IMPORTED_MODULE_4__}' class='trash-icon' id='${entry.id}' alt='more-icon'>\r\n      </div>`;\r\n    })\r\n    listWindow.innerHTML = lists;\r\n    const dispose = document.querySelector('.trash-icon');\r\n    this.dump(dispose)    \r\n  }\r\n\r\n  dump(dispose) {\r\n    dispose.forEach((can) => {\r\n      can.addEventListener('click', () => {\r\n        const index = can.getattribute('id');\r\n        this.toDoList.splice(index,1);\r\n        localStorage.setItem('compiled', JSON.stringify(this.toDoList));\r\n        this.listRender();\r\n      })\r\n    })\r\n  }\r\n}\r\n// window.addEventListener('load', tasksRender);\r\n_modules_variables__WEBPACK_IMPORTED_MODULE_5__.enterImg.addEventListener('click', () => {\r\n  console.log('clicked');\r\n  if(!_modules_variables__WEBPACK_IMPORTED_MODULE_5__.addInput.value) return;\r\n  else {\r\n  const plan = new Manager;\r\n  plan.listAddition(_modules_variables__WEBPACK_IMPORTED_MODULE_5__.addInput.value);\r\n  _modules_variables__WEBPACK_IMPORTED_MODULE_5__.addInput.value = '';\r\n  }\r\n}); \r\n\r\n\r\n// const tasksRender = () => {\r\n//   const listWindow = document.querySelector('.list-window');\r\n//   let lists = '';\r\n\r\n//   const listSort = (arr) => arr.slice().sort((a, b) => a.index - b.index);\r\n\r\n//   const sortedList = listSort(toDoList);\r\n\r\n//   sortedList.forEach((entry) => {\r\n//     lists += `<div class=\"entry\">\r\n//         <div>\r\n//         <input type=\"checkbox\" class=\"boxes\" name=\"status\" id=\"status\">\r\n//         <input type=\"text\" size=\"125\" class=\"detail\" value=\"${entry.description}\"></input>\r\n//         </div>\r\n//         <img src='${Thirdicon}' class='more-icon active' alt='more-icon'>\r\n//         <img src='${Fourthicon}' class='trash-icon' alt='more-icon'>\r\n//         </div>`;\r\n//   });\r\n\r\n//   listWindow.innerHTML = lists;\r\n// };\r\n\r\n// window.addEventListener('load', tasksRender);\r\n\n\n//# sourceURL=webpack://my-to-do-list/./src/index.js?");
